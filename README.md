...
Both models are trained & evaluated using a **shared stratified split (70% train / 10% validation / 20% test)** to ensure a **fair and statistical comparison**.
...
- 🔹 Full model introspection (W, b, logits, softmax)  
...
This work is submitted as a **graduation requirement** for the **Bachelor’s degree in Statistics**  
...
| Metrics | ROC-AUC, Macro-F1, Calibration, McNemar Test |
| Language | Python (3.9+) |
